// Suppress the node:sqlite ExperimentalWarning in production
...
// Middleware
// FIX #24: Restrict CORS to localhost only — this is an offline system.
// Wildcard CORS (allow all origins) was replaced with an explicit origin
// whitelist to prevent any external page from making API calls to this server.
app.use(cors({
  origin: ['http://127.0.0.1:4580', 'http://localhost:4580'],
